...
const Account: NextPage = () => {
  ...
  const deleteMutation = useMutation(
    () => {
      return fetch('/api/deleteAccount', {method: 'DELETE'});
    },
    {
      onSuccess: () => {
        ...
        <div className="absolute">
          {
            ...
            >
              ...
              <p>
                Please note that deleting an organization will also delete all memberships and invitations. This is not
                reversible.
              </p>
              <button onClick={() => router.push('/settings/account')} className="rounded bg-gray-200 p-2">
                Cancel
              </button>
              <button onClick={() => deleteMutation.mutate()} className="bg-red-200 rounded ml-2 p-2">
                Delete
              </button>
            </Modal>
          }
